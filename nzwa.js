...
/*************Auto respon************/
   ...
   if (budy.match('Hai')){costum('Hai juga saya bot ketik #help untuk melihat nenu', text, tescuk, menuc)
   }
   if(budy.match('Bot')){
...
/***********IKLAN BOT**************/
if (budy.match('A1')){costum(`*LIST HARGA 💎 FREEFIRE*
...
*1420💎:180.500*
*1775💎:225.500*
*2130💎:270.500*`, text, tescuk, menuc)}

if (budy.match('A2')){costum(`*✨LIST HARGA GS(stok terbatas)✨*
🌈33GS || 9.350
🌈66GS || 18.400
🌈165GS || 46.600
🌈330GS || 91.500`, text, tescuk, menuc)}

if (budy.match('A3')){costum(` _FORMAT ORDER_ 
...
*PAYMENT💳*
GOPAY : 082189624256 // A.N HerminL
DANA : 082189624256 // A.N HerminL 
*NB : SERTAKAN BUKTI TF!* `, text, tescuk, menuc)}

if (budy.match('Menu')){costum(`❏─────「 List Menu 」───────
|• A1 : Menampilkan Harga DM Free Fire
|• A2 : Menampilkan Harga Garena Shell
|• A3 : Menampilkan Format Order dan Payment
|
|For Admins
|open : Open Group
|close : Close Group
|tagall : Tag Semua Member
|upgname : Ubah Nama Grup
|
|Anti Link Already Active
❏─────「 Note 」────`, text, tescuk, menuc)}
			...
			switch(command) {
                     ...
                     break
                                case 'educationmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await cost(education(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'funmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(fun(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'groupmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(group(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'imagemakermenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(imagemaker(prefix, botName, ownerName, _registered, timer), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'informationmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(information(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'islammenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(islam(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'kerangmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(kerang(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'logomakermenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(logomaker(prefix, botName, ownerName, _registered, timer), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'mememenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(meme(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'musicmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(music(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'othermenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(other(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'ownermenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(owner(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'searchmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(search(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'soundmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(sound(prefix, botName, ownerName, _registered), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'stalkmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(stalk(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'stayonscreenmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(stayonscreen(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'stickermakermenu':
                                case 'stikermakermenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(stickermaker(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'todmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(tod(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'getmenu':

                                        if (!isRegister) return reply(mess.only.daftarB)

                                        await costum(getm(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'wibumenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(wibu(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'xpmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(xp(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break
                                case 'limitmenu':
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        await costum(limit(prefix, botName, ownerName, _registered, time), text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { mimetype: "image/jpeg", "caption": '*HLXBOT* ❤️', "jpegThumbnail": fs.readFileSync('./temp/image/HLXB.jpeg') } } } } )
                                        break 
                  case 'timer':
...
//--Info bot
  ...
  anu = fetchJson('https://i.ibb.co/Z6pNFDf/95ee00ead851.jpg')
		...
		case 'infonomor':
               nzwa.updatePresence(from, Presence.composing) 
				...
				case 'tulis':
					...
					teks = body.slice(7)
					reply(mess.wait)
					anu = await fetchJson(`https://onlydevcity.herokuapp.com/api/nulis?text=${teks}&apikey=onlyonedeveloper`, {method: 'get'})
					if (anu.error) return reply(anu.error)
	    ...
	    case 'kapankah':
			...
			case 'closegc':
				...
				var cuk = {
					...
					nzwa.sendMessage(from, buffer, audio, cuk, { mimetype: 'audio/mp4', quoted: mek, ptt: true })
					} catch {
				  reply('Pack tidak terdaftar')
				}
					break
				...
				case 'stikergif':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								nzwa.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek, cr})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								...
								nzwa.sendMessage(from, buff, sticker, cr)
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
							.addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
	          ...
	          if (!isRegister) return reply(mess.only.daftarB)
               ...
               if (anu.error) return reply(anu.error)
			    ...
			    case 'waifu':
					...
					buffer = await getBuffer(anu.result)
					nzwa.sendMessage(from, anu, image,{quoted: mek})
                                        await limitAdd(sender)
					break
				case 'randomanime':
                ...
                case 'truth':
					...
					nzwa.sendMessage(from, tod, image, { caption: '*Dare*\n\n'+ der, quoted: mek })
					break	
                case 'level':
            ...
            break
				...
				case 'clone':
					...
					break
                                        ...
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        anu = await fetchJson(`https://api.zeks.xyz/api/pubglogo?text1=${teks1}&text2=${teks2}&apikey=apivinz`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
...
//case 'antidelete':
				...
				const isBanCtRevoke = dataBanCtRevoke.includes() ? true : false
				const argz = body.split(' ')
				if (argz.length === 1) return nzwa.sendMessage(from, `Penggunaan fitur antidelete :\n\n*${prefix}antidelete [aktif/mati]* (Untuk grup)\n*${prefix}antidelete [ctaktif/ctmati]* (untuk semua kontak)\n*${prefix}antidelete banct 628558xxxxxxx* (banlist kontak)`, MessageType.text)
				if (argz[1] == 'aktif') {
					if (isGroup) {
						if (isRevoke) return nzwa.sendMessage(from, `Antidelete telah diaktifkan di grup ini sebelumnya!`, MessageType.text)
						dataRevoke.push(from)
						fs.writeFileSync('./lib/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
						nzwa.sendMessage(from, `*Succes Enable Antidelete Grup!*`, MessageType.text)
					} else if (!isGroup) {
						nzwa.sendMessage(from, `Untuk kontak penggunaan *${prefix}antidelete ctaktif*`, MessageType.text)
					}
				} else if (argz[1] == 'ctaktif') {
					if (!isGroup) {
						if (isCtRevoke) return nzwa.sendMessage(from, `Antidelete telah diaktifkan di semua kontak sebelumnya!`, MessageType.text)
						dataCtRevoke.data = true
						fs.writeFileSync('./lib/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
						nzwa.sendMessage(from, `Antidelete diaktifkan disemua kontak!`, MessageType.text)
					} else if (isGroup) {
						nzwa.sendMessage(from, `Untuk grup penggunaan *${prefix}antidelete aktif*`, MessageType.text)
					}
				} else if (argz[1] == 'banct') {
					if (isBanCtRevoke) return nzwa.sendMessage(from, `kontak ini telah ada di database banlist!`, MessageType.text)
					if (argz.length === 2 || argz[2].startsWith('0')) return nzwa.sendMessage(from, `Masukan nomer diawali dengan 62! contoh 62859289xxxxx`, MessageType.text)
					dataBanCtRevoke.push(argz[2] + '@s.whatsapp.net')
					fs.writeFileSync('./lib/ct-revoked-banlist.json', JSON.stringify(dataBanCtRevoke, null, 2))
					nzwa.sendMessage(from, `Kontak ${argz[2]} telah dimasukan ke banlist antidelete secara permanen!`, MessageType.text)
				} else if (argz[1] == 'mati') {
					if (isGroup) {
						const index = dataRevoke.indexOf(from)
						dataRevoke.splice(index, 1)
						fs.writeFileSync('./lib/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
						nzwa.sendMessage(from, `*Succes disable Antidelete Grup!*`, MessageType.text)
					} else if (!isGroup) {
						nzwa.sendMessage(from, `Untuk kontak penggunaan *${prefix}antidelete ctmati*`, MessageType.text)
					}
				} else if (argz[1] == 'ctmati') {
					if (!isGroup) {
						dataCtRevoke.data = false
						fs.writeFileSync('./lib/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
						nzwa.sendMessage(from, `Antidelete dimatikan disemua kontak!`, MessageType.text)
					} else if (isGroup) {
						nzwa.sendMessage(from, `Untuk grup penggunaan *${prefix}antidelete mati*`, MessageType.text)
					}
				}
				break
                                case 'leaderboard':
